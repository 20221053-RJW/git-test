...
export default function EvalSchemaNotice({ missingTables, legacyPeerDisplayTable }: Props) {
  ...
  return (
    <div
      className="cc-alert-warning rounded-xl px-4 py-3 text-sm"
    ...
    >
      ...
      <p className="mt-2">
        ...
        <span className="cc-alert-warning-muted text-xs"> (생성: npm run supabase:apply-remote-full)</span>
      </p>
      <p className="cc-alert-warning-muted mt-2 text-xs">
