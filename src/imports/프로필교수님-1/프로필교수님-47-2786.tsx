...
function Container8() {
  return (
    <div className="bg-[#f0f0f0] flex-[1100_0_0] min-h-px relative w-[1536px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Section />
      </div>
    </div>
...
function Container7() {
  return (
    <div className="flex-[1536_0_0] h-[1445px] min-w-px relative" data-name="Container">
...
export default function Component() {
  return (
    <div className="bg-gradient-to-b content-stretch flex flex-col from-[#151515] items-start relative size-full to-[#454545]" data-name="프로필-교수님">
      <App />
    </div>
  );
}