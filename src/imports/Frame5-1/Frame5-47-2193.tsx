...
function Container10() {
  return (
    <div className="h-[980px] relative shrink-0 w-full" data-name="Container">
      <Container11 />
      <Container15 />
      <Container19 />
      <Container23 />
...
function Section() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[1036px] items-start left-[16px] right-[16px] top-[32px]" data-name="Section">
      <Container9 />
      <Container10 />
    </div>
  );
...
function Container8() {
  return (
    <div className="absolute bg-[#f0f0f0] h-[1086px] left-0 top-0 w-[1536px]" data-name="Container">
      <Section />
      <div className="absolute bg-[rgba(45,45,45,0.7)] h-[1100px] left-0 top-0 w-[1536px]" />
    </div>
  );
}
...
function Footer() {
  return (
    <div className="absolute bg-black h-[345px] left-0 top-[1100px] w-[1536px]" data-name="Footer">
      <Container39 />
      <Container43 />
    </div>
  );
...
function Container7() {
  return (
    <div className="flex-[1536_0_0] h-[1438px] min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container8 />
        <Footer />
      </div>
...
function Container6() {
  return (
    <div className="absolute content-stretch flex h-[1445px] items-start left-0 top-[64px] w-[1536px]" data-name="Container">
      <Container7 />
    </div>
  );
}
...
function Component() {
  return (
    <div className="absolute bg-gradient-to-b content-stretch flex flex-col from-[#151515] items-start left-0 to-[#454545] top-0" data-name="프로필-학생들">
      <App />
    </div>
  );
}
...
function Heading11() {
  return (
    <div className="absolute h-[32px] left-[32px] top-[32px] w-[384px]" data-name="Heading 2">
      <p className="absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[32px] left-0 not-italic right-0 text-[#0f172a] text-[24px] top-0">내 정보 수정</p>
    </div>
  );
}
...
function Label() {
  return (
    <div className="absolute h-[20px] left-0 right-[469px] top-0" data-name="Label">
      <p className="absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[20px] left-0 not-italic text-[#364153] text-[14px] top-[-0.5px] whitespace-nowrap">전공</p>
    </div>
  );
}
...
function TextInput() {
  return (
    <div className="absolute h-[42px] left-0 right-[446px] rounded-[10px] top-[24px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip p-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#1e2939] text-[14px] whitespace-nowrap">벤처중소기업학 / 글로벌미디어 복수전공</p>
      </div>
...
function Label1() {
  return (
    <div className="absolute h-[20px] left-[450px] right-[19px] top-[-1px]" data-name="Label">
      <p className="absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[20px] left-0 not-italic text-[#364153] text-[14px] top-[-0.5px] whitespace-nowrap">mbti 및 성격</p>
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="absolute h-[42px] left-[450px] right-0 rounded-[10px] top-[23px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip p-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#1e2939] text-[14px] whitespace-nowrap">intp, 꼼꼼함, 완벽주의자</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d1d5dc] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
  );
...
function Container44() {
  return (
    <div className="absolute h-[66px] left-[32px] right-[33px] top-[88px]" data-name="Container">
      <Label />
      <TextInput />
      <Label1 />
      <TextInput1 />
...
function Label2() {
  return (
    <div className="absolute h-[20px] left-0 right-0 top-0" data-name="Label">
      <p className="absolute font-['Inter:Bold','Noto_Sans_KR:Bold','Noto_Sans_KR:Regular',sans-serif] font-bold leading-[0] left-0 not-italic text-[#364153] text-[0px] top-[-0.5px] whitespace-nowrap">
        <span className="leading-[20px] text-[14px]">{`진로 관심분야 `}</span>
        <span className="font-['Inter:Regular','Noto_Sans_KR:Bold','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[16px] text-[#99a1af] text-[12px]">(쉼표로 구분)</span>
      </p>
    </div>
  );
}
...
function TextInput2() {
  return (
    <div className="absolute h-[42px] left-0 right-0 rounded-[10px] top-[24px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip p-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#1e2939] text-[14px] whitespace-nowrap">기획/디자인</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d1d5dc] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
  );
...
function Container45() {
  return (
    <div className="absolute h-[66px] left-[32px] right-[33px] top-[171px]" data-name="Container">
      <Label2 />
      <TextInput2 />
    </div>
  );
...
function Label3() {
  return (
    <div className="absolute h-[20px] left-0 right-0 top-0" data-name="Label">
      <p className="absolute font-['Inter:Bold','Noto_Sans_KR:Bold','Noto_Sans_KR:Regular',sans-serif] font-bold leading-[0] left-0 not-italic text-[#364153] text-[0px] top-[-0.5px] whitespace-nowrap">
        <span className="leading-[20px] text-[14px]">{`취미 및 관심사 `}</span>
        <span className="font-['Inter:Regular','Noto_Sans_KR:Bold','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[16px] text-[#99a1af] text-[12px]">(쉼표로 구분)</span>
      </p>
    </div>
  );
...
function TextInput3() {
  return (
    <div className="absolute h-[42px] left-0 right-0 rounded-[10px] top-[24px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip p-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#1e2939] text-[14px] whitespace-nowrap">기아타이거즈, TFT</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d1d5dc] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
  );
...
function Container46() {
  return (
    <div className="absolute h-[66px] left-[32px] right-[33px] top-[254px]" data-name="Container">
      <Label3 />
      <TextInput3 />
    </div>
  );
...
function Label4() {
  return (
    <div className="absolute h-[20px] left-0 right-0 top-0" data-name="Label">
      <p className="absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[20px] left-0 not-italic text-[#364153] text-[14px] top-[-0.5px] whitespace-nowrap">간단한 자기소개</p>
    </div>
  );
}
...
function TextInput4() {
  return (
    <div className="absolute h-[42px] left-0 right-0 rounded-[10px] top-[24px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip p-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#1e2939] text-[14px] whitespace-nowrap">안녕하세요. 저는 벤처중소기업학과 22학번 류지원입니다. 서비스 기획에 관심이 있고 연락 잘 됩니다.</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d1d5dc] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
  );
...
function Container48() {
  return (
    <div className="absolute h-[66px] left-0 right-0 top-0" data-name="Container">
      <Label4 />
      <TextInput4 />
    </div>
  );
...
function Container47() {
  return (
    <div className="absolute h-[66px] left-[32px] right-[33px] top-[337px]" data-name="Container">
      <Container48 />
    </div>
  );
}
...
function Label5() {
  return (
    <div className="absolute h-[20px] left-[32px] right-[33px] top-[420px]" data-name="Label">
      <p className="absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[20px] left-0 not-italic text-[#364153] text-[14px] top-[-0.5px] whitespace-nowrap">포트폴리오 파일 업로드</p>
    </div>
  );
}
...
function Text49() {
  return (
    <div className="absolute h-[32px] left-[421.02px] top-[60px] w-[32.953px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[32px] left-0 not-italic right-0 text-[#1e2939] text-[24px] top-0">📂</p>
    </div>
  );
}
...
function Text50() {
  return (
    <div className="absolute h-[20px] left-[376.58px] top-[96px] w-[121.844px]" data-name="Text">
      <p className="absolute font-['Inter:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#4a5565] text-[14px] top-[-0.5px] whitespace-nowrap">클릭하여 파일 선택</p>
    </div>
  );
}
...
function Text51() {
  return (
    <div className="absolute h-[16px] left-[367.38px] top-[120px] w-[140.25px]" data-name="Text">
      <p className="absolute font-['Inter:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[16px] left-0 not-italic text-[#99a1af] text-[12px] top-0 whitespace-nowrap">PDF, ZIP, PPT (최대 50MB)</p>
    </div>
  );
}
...
function Label6() {
  return (
    <div className="absolute border-2 border-[#d1d5dc] border-dashed h-[201px] left-[32px] right-[33px] rounded-[10px] top-[444px]" data-name="Label">
      <Text49 />
      <Text50 />
      <Text51 />
    </div>
...
function Group() {
  return (
    <div className="absolute contents left-[32px] right-[33px] top-[420px]">
      <Label5 />
      <Label6 />
    </div>
  );
...
function Button3() {
  return (
    <div className="bg-[#f3f4f6] h-[44px] relative rounded-[10px] shrink-0 w-[72px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[24px] left-[36px] not-italic text-[#364153] text-[16px] text-center top-[8px] whitespace-nowrap">취소</p>
      </div>
    </div>
  );
}
...
function Button4() {
  return (
    <div className="bg-[#3676ff] drop-shadow-[0px_1px_1.5px_rgba(0,0,0,0.1),0px_1px_1px_rgba(0,0,0,0.1)] h-[44px] relative rounded-[10px] shrink-0 w-[104px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[24px] left-[52.5px] not-italic text-[16px] text-center text-white top-[8px] whitespace-nowrap">저장하기</p>
      </div>
    </div>
  );
}
...
function Container49() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[44px] items-start justify-end left-[179px] top-[701px] w-[384px]" data-name="Container">
      <Button3 />
      <Button4 />
    </div>
  );
...
function Frame() {
  return (
    <div className="-translate-y-1/2 absolute bg-white drop-shadow-[0px_25px_25px_rgba(0,0,0,0.25)] h-[789px] left-[281px] rounded-[14px] top-[calc(50%-152px)] w-[944px]" data-name="Frame">
      <Heading11 />
      <Container44 />
      <Container45 />
      <Container46 />
      ...
      <p className="-translate-x-1/2 absolute font-['Inter:Bold',sans-serif] font-bold h-[62px] leading-[24px] left-[911px] not-italic text-[#979797] text-[25px] text-center top-[18px] w-[180px]">X</p>
    </div>
  );
}
