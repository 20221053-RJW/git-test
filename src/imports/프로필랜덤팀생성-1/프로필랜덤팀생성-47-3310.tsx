...
import img20260429221251 from "./5cbf5d34925f8d7eb172f49878c9ca434886e34d.png";
...
function Navigation() {
  return (
    <div className="absolute bg-gradient-to-r content-stretch drop-shadow-[0px_10px_7.5px_rgba(0,0,0,0.1),0px_4px_3px_rgba(0,0,0,0.1)] flex flex-col from-[#0028bb] h-[64px] items-start left-0 px-[128px] to-black top-0 via-[#001663] via-[35%] w-[1536px]" data-name="Navigation">
...
function Image() {
  return (
    <div className="absolute left-0 size-[64px] top-0" data-name="Image (김철수)">
...
function Container16() {
  return (
    <div className="absolute bg-[#eff6ff] left-[146.5px] overflow-clip rounded-[16777200px] size-[64px] top-[24px]" data-name="Container">
      <Image />
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="absolute h-[16px] left-[142.5px] top-[140px] w-[72px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic right-0 text-[#6a7282] text-[12px] text-center top-0">시각디자인과</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="absolute h-[19.5px] left-[16px] right-[16px] top-[12px]" data-name="Paragraph">
...
function Container17() {
  return (
    <div className="absolute bg-[#eff6ff] border border-[#bedbff] border-solid h-[45.5px] left-[24px] rounded-[10px] top-[172px] w-[309px]" data-name="Container">
      <Paragraph3 />
    </div>
  );
}
...
function Text13() {
  return (
    <div className="absolute content-stretch flex h-[32px] items-start left-[20px] top-[16px] w-[24px]" data-name="Text">
...
function Paragraph4() {
  return (
    <div className="absolute h-[16px] left-[142.5px] top-[140px] w-[72px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic right-0 text-[#6a7282] text-[12px] text-center top-0">소프트웨어학</p>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="absolute h-[980px] left-0 right-0 top-[56px]" data-name="Container">
      <Container11 />
      <div className="absolute bg-[#155dfc] h-[33px] left-[28px] rounded-[7px] top-[207px] w-[234px]" />
      <Container15 />
      <Container19 />
      <Container23 />
      <Container27 />
      ...
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold h-[32px] leading-[32px] left-[147.5px] not-italic text-[20px] text-center text-white top-[207px] w-[229px]">랜덤 팀 생성 +</p>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="absolute h-[1445px] left-0 right-0 top-[15px]" data-name="Container">
      <Container8 />
      <div className="absolute bg-[rgba(45,45,45,0.76)] h-[1115px] left-0 top-[-15px] w-[1536px]" />
      <Footer />
    </div>
  );
}
...
function Group() {
  return (
    <div className="absolute contents left-[275px] top-[105px]">
      <div className="absolute bg-[#155dfc] h-[44px] left-[275px] rounded-[10px] top-[105px] w-[201px]" />
      <div className="absolute bg-[#155dfc] h-[44px] left-[502px] rounded-[10px] top-[105px] w-[201px]" />
      <div className="absolute bg-[#155dfc] h-[44px] left-[729px] rounded-[10px] top-[105px] w-[201px]" />
      <div className="absolute bg-[#155dfc] h-[44px] left-[956px] rounded-[10px] top-[105px] w-[201px]" />
      <div className="absolute bg-[#b0b0b0] h-[44px] left-[1182px] rounded-[10px] top-[105px] w-[65px]" />
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold h-[31px] leading-[32px] left-[375.5px] not-italic text-[20px] text-center text-white top-[112px] w-[171px]">4명</p>
      <div className="absolute bg-[#155dfc] h-[44px] left-[661px] rounded-[10px] top-[1048px] w-[201px]" />
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold h-[31px] leading-[32px] left-[761.5px] not-italic text-[20px] text-center text-white top-[1055px] w-[171px]">생성</p>
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold h-[31px] leading-[32px] left-[602.5px] not-italic text-[20px] text-center text-white top-[112px] w-[171px]">비 작성자 균등 배분</p>
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold h-[31px] leading-[32px] left-[829.5px] not-italic text-[20px] text-center text-white top-[112px] w-[171px]">상반된 진로 분야</p>
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold h-[31px] leading-[32px] left-[1057.5px] not-italic text-[20px] text-center text-white top-[112px] w-[171px]">상반된 성격</p>
      <p className="-translate-x-1/2 absolute font-['Inter:Bold',sans-serif] font-bold h-[31px] leading-[32px] left-[1214.5px] not-italic text-[30px] text-center text-white top-[108px] w-[171px]">+</p>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="absolute h-[1445px] left-0 top-[64px] w-[1536px]" data-name="Container">
      <Container7 />
      <div className="absolute bg-white h-[1084px] left-[163px] rounded-[20px] top-[31px] w-[1206px]" />
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold h-[31px] leading-[32px] left-[775.5px] not-italic text-[25px] text-black text-center top-[57px] w-[171px]">키워드 선택</p>
      <Group />
    </div>
  );
}
...
function Heading11() {
  return (
    <div className="absolute h-[28px] left-[358px] top-[317px] w-[91.219px]" data-name="Heading 5">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[25px] text-center top-[-1px] whitespace-nowrap">1팀</p>
    </div>
  );
}
...
function Container45() {
  return (
    <div className="absolute bg-[#eff6ff] content-stretch flex items-center justify-center left-[85px] overflow-clip px-[20px] rounded-[16777200px] size-[64px] top-[5px]" data-name="Container">
      <Text49 />
    </div>
  );
}
...
function Heading12() {
  return (
    <div className="absolute h-[28px] left-[70.89px] top-[77px] w-[91.219px]" data-name="Heading 4">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[18px] text-center top-[-1px] whitespace-nowrap">{`류지원 `}</p>
    </div>
  );
}
...
function Paragraph17() {
  return (
    <div className="absolute content-stretch flex h-[16px] items-start left-[5.79px] top-[113px] w-[221.414px]" data-name="Paragraph">
      <p className="flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[16px] min-w-px not-italic relative text-[#6a7282] text-[12px] text-center">벤처중소기업학 / 글로벌미디어 복수전공</p>
    </div>
  );
}
...
function Text51() {
  return (
    <div className="absolute bg-[#f3f4f6] h-[27px] left-[130.58px] rounded-[16777200px] top-0 w-[86.07px]" data-name="Text">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[15px] left-[43.5px] not-italic text-[#4a5565] text-[10px] text-center top-[5.5px] whitespace-nowrap">#intp</p>
    </div>
  );
}
...
function Text52() {
  return (
    <div className="absolute bg-[#f3f4f6] h-[27px] left-[222.65px] rounded-[16777200px] top-0 w-[41.805px]" data-name="Text">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[15px] left-[21.5px] not-italic text-[#4a5565] text-[10px] text-center top-[5.5px] whitespace-nowrap">#꼼꼼</p>
    </div>
  );
}
...
function Container46() {
  return (
    <div className="absolute h-[27px] left-[-39px] top-[134px] w-[309px]" data-name="Container">
      <Text50 />
      <Text51 />
      <Text52 />
    </div>
...
function Container44() {
  return (
    <div className="absolute bg-white h-[170px] left-[236px] rounded-[14px] top-[276px] w-[233px]" data-name="Container">
      <Container45 />
      <Heading12 />
      <Paragraph17 />
      <Container46 />
...
function Image3() {
  return (
    <div className="absolute h-[64px] left-[11.5px] top-0 w-[75px]" data-name="Image (김철수)">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage} />
    </div>
  );
}
...
function Container50() {
  return (
    <div className="bg-[#eff6ff] h-[64px] relative rounded-[16777200px] shrink-0 w-[86px]" data-name="Container">
...
function Text54() {
  return (
    <div className="h-[32px] relative shrink-0 w-[24px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[32px] left-[11.5px] not-italic text-[#2b7fff] text-[24px] text-center top-0 whitespace-nowrap">류</p>
      </div>
    </div>
  );
}
...
function Container49() {
  return (
    <div className="absolute bg-[#eff6ff] content-stretch flex items-center justify-center left-0 overflow-clip px-[20px] rounded-[16777200px] size-[64px] top-0" data-name="Container">
      <Container50 />
      <Text54 />
    </div>
  );
...
function Container48() {
  return (
    <div className="absolute bg-[#eff6ff] left-[85px] overflow-clip rounded-[16777200px] size-[64px] top-[5px]" data-name="Container">
      <Text53 />
      <Container49 />
    </div>
  );
...
function Heading13() {
  return (
    <div className="absolute h-[28px] left-[70.89px] top-[77px] w-[91.219px]" data-name="Heading 4">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[18px] text-center top-[-1px] whitespace-nowrap">{`김철수 `}</p>
    </div>
  );
}
...
function Paragraph18() {
  return (
    <div className="absolute content-stretch flex h-[16px] items-start left-[5.79px] top-[113px] w-[221.414px]" data-name="Paragraph">
      <p className="flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[16px] min-w-px not-italic relative text-[#6a7282] text-[12px] text-center">시각디자인</p>
    </div>
  );
}
...
function Text55() {
  return (
    <div className="absolute bg-[#f3f4f6] h-[27px] left-[44.55px] rounded-[16777200px] top-0 w-[80.031px]" data-name="Text">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[15px] left-[40.5px] not-italic text-[#4a5565] text-[10px] text-center top-[5.5px] whitespace-nowrap">#프론트엔드</p>
    </div>
  );
}
...
function Text56() {
  return (
    <div className="absolute bg-[#f3f4f6] h-[27px] left-[130.58px] rounded-[16777200px] top-0 w-[86.07px]" data-name="Text">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[15px] left-[43px] not-italic text-[#4a5565] text-[10px] text-center top-[5.5px] whitespace-nowrap">#estj</p>
    </div>
  );
}
...
function Text57() {
  return (
    <div className="absolute bg-[#f3f4f6] h-[27px] left-[222.65px] rounded-[16777200px] top-0 w-[41.805px]" data-name="Text">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[15px] left-[21.5px] not-italic text-[#4a5565] text-[10px] text-center top-[5.5px] whitespace-nowrap">#활발</p>
    </div>
  );
}
...
function Container51() {
  return (
    <div className="absolute h-[27px] left-[-39px] top-[134px] w-[309px]" data-name="Container">
      ...
      <Text56 />
      <Text57 />
      <p className="-translate-x-1/2 absolute font-['Inter:Bold',sans-serif] font-bold h-[62px] leading-[24px] left-[879px] not-italic text-[#979797] text-[25px] text-center top-[-293px] w-[180px]">X</p>
    </div>
  );
}
...
function Container47() {
  return (
    <div className="absolute bg-white h-[170px] left-[490px] rounded-[14px] top-[276px] w-[233px]" data-name="Container">
      <Container48 />
      <Heading13 />
      <Paragraph18 />
      <Container51 />
...
function Container55() {
  return (
    <div className="absolute bg-[#eff6ff] content-stretch flex items-center justify-center left-[0.5px] overflow-clip rounded-[16777200px] size-[64px] top-0" data-name="Container">
      <Image4 />
    </div>
  );
}
...
function Container54() {
  return (
    <div className="absolute bg-[#eff6ff] left-0 overflow-clip rounded-[16777200px] size-[64px] top-0" data-name="Container">
      <Text59 />
      <Container55 />
    </div>
  );
...
function Heading14() {
  return (
    <div className="absolute h-[28px] left-[70.89px] top-[77px] w-[91.219px]" data-name="Heading 4">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[18px] text-center top-[-1px] whitespace-nowrap">최수민</p>
    </div>
  );
}
...
function Text60() {
  return (
    <div className="absolute bg-[#f3f4f6] h-[27px] left-[44.55px] rounded-[16777200px] top-0 w-[80.031px]" data-name="Text">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[15px] left-[40px] not-italic text-[#4a5565] text-[10px] text-center top-[5.5px] whitespace-nowrap">#백엔드</p>
    </div>
  );
}
...
function Text61() {
  return (
    <div className="absolute bg-[#f3f4f6] h-[27px] left-[130.58px] rounded-[16777200px] top-0 w-[86.07px]" data-name="Text">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[15px] left-[43px] not-italic text-[#4a5565] text-[10px] text-center top-[5.5px] whitespace-nowrap">#isfp</p>
    </div>
  );
}
...
function Text62() {
  return (
    <div className="absolute bg-[#f3f4f6] h-[27px] left-[222.65px] rounded-[16777200px] top-0 w-[41.805px]" data-name="Text">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[15px] left-[21.5px] not-italic text-[#4a5565] text-[10px] text-center top-[5.5px] whitespace-nowrap">#섬세</p>
    </div>
  );
}
...
function Container52() {
  return (
    <div className="absolute bg-white h-[170px] left-[236px] rounded-[14px] top-[465px] w-[233px]" data-name="Container">
      <Container53 />
      <Heading14 />
      <Paragraph19 />
      <Container56 />
...
function Heading15() {
  return (
    <div className="absolute h-[28px] left-[71.1px] top-[92px] w-[91.219px]" data-name="Heading 4">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[18px] text-center top-[-1px] whitespace-nowrap">성한빈</p>
    </div>
  );
}

function Paragraph20() {
  return <div className="absolute h-[16px] left-[6px] top-[128px] w-[221.414px]" data-name="Paragraph" />;
}

function Text63() {
  return <div className="h-[32px] relative shrink-0 w-[24px]" data-name="Text" />;
}

function Container58() {
  return (
    <div className="absolute bg-[#eff6ff] content-stretch flex items-center justify-center left-[84.21px] overflow-clip px-[20px] rounded-[16777200px] size-[64px] top-[27px]" data-name="Container">
      <Text63 />
    </div>
  );
}
...
function Container57() {
  return (
    <div className="absolute bg-white h-[170px] left-[490px] rounded-[14px] top-[465px] w-[233px]" data-name="Container">
      <Heading15 />
      <Paragraph20 />
      <Container58 />
    </div>
...
function Heading16() {
  return (
    <div className="absolute h-[28px] left-[1005px] top-[316px] w-[91.219px]" data-name="Heading 7">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[25px] text-center top-[-1px] whitespace-nowrap">1팀</p>
    </div>
  );
}
...
function Heading17() {
  return (
    <div className="absolute h-[28px] left-[1005px] top-[240px] w-[91.219px]" data-name="Heading 8">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46.5px] not-italic text-[#101828] text-[25px] text-center top-[-1px] whitespace-nowrap">2팀</p>
    </div>
  );
}
...
function Heading18() {
  return (
    <div className="absolute h-[28px] left-[70.89px] top-[77px] w-[91.219px]" data-name="Heading 4">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[18px] text-center top-[-1px] whitespace-nowrap">류지민</p>
    </div>
  );
}
...
function Container59() {
  return (
    <div className="absolute bg-white h-[170px] left-[808px] rounded-[14px] top-[275px] w-[233px]" data-name="Container">
      <Container60 />
      <Heading18 />
      <Paragraph21 />
      <Container61 />
...
function Heading19() {
  return (
    <div className="absolute h-[28px] left-[70.89px] top-[77px] w-[91.219px]" data-name="Heading 4">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[18px] text-center top-[-1px] whitespace-nowrap">김유리</p>
    </div>
  );
}
...
function Container62() {
  return (
    <div className="absolute bg-white h-[170px] left-[1062px] rounded-[14px] top-[275px] w-[233px]" data-name="Container">
      <Container63 />
      <Heading19 />
      <Paragraph22 />
      <Container66 />
...
function Heading20() {
  return (
    <div className="absolute h-[28px] left-[70.89px] top-[77px] w-[91.219px]" data-name="Heading 4">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[18px] text-center top-[-1px] whitespace-nowrap">최민수</p>
    </div>
  );
}
...
function Container67() {
  return (
    <div className="absolute bg-white h-[170px] left-[808px] rounded-[14px] top-[464px] w-[233px]" data-name="Container">
      <Container68 />
      <Heading20 />
      <Paragraph23 />
      <Container71 />
...
function Heading21() {
  return (
    <div className="absolute h-[28px] left-[71.1px] top-[92px] w-[91.219px]" data-name="Heading 4">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[18px] text-center top-[-1px] whitespace-nowrap">김운학</p>
    </div>
  );
}
...
function Container72() {
  return (
    <div className="absolute bg-white h-[170px] left-[1062px] rounded-[14px] top-[464px] w-[233px]" data-name="Container">
      <Heading21 />
      <Container73 />
    </div>
  );
...
function Group1() {
  return (
    <div className="absolute contents left-[808px] top-[275px]">
      <Container59 />
      <Container62 />
      <Container67 />
      <Container72 />
...
function Heading22() {
  return (
    <div className="absolute h-[28px] left-[432px] top-[680px] w-[91.219px]" data-name="Heading 9">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[25px] text-center top-[-1px] whitespace-nowrap">3팀</p>
    </div>
  );
}
...
function Heading23() {
  return (
    <div className="absolute h-[28px] left-[70.89px] top-[77px] w-[91.219px]" data-name="Heading 4">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[18px] text-center top-[-1px] whitespace-nowrap">류세아</p>
    </div>
  );
}
...
function Paragraph24() {
  return (
    <div className="absolute content-stretch flex h-[16px] items-start left-[5.79px] top-[113px] w-[221.414px]" data-name="Paragraph">
      <p className="flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[16px] min-w-px not-italic relative text-[#6a7282] text-[12px] text-center">글로벌미디어 복수전공</p>
    </div>
  );
}
...
function Container74() {
  return (
    <div className="absolute bg-white h-[170px] left-[235px] rounded-[14px] top-[715px] w-[233px]" data-name="Container">
      <Container75 />
      <Heading23 />
      <Paragraph24 />
      <Container76 />
...
function Heading24() {
  return (
    <div className="absolute h-[28px] left-[70.89px] top-[77px] w-[91.219px]" data-name="Heading 4">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[18px] text-center top-[-1px] whitespace-nowrap">{`김짱구 `}</p>
    </div>
  );
}
...
function Container77() {
  return (
    <div className="absolute bg-white h-[170px] left-[489px] rounded-[14px] top-[715px] w-[233px]" data-name="Container">
      <Container78 />
      <Heading24 />
      <Paragraph25 />
      <Container81 />
...
function Heading25() {
  return (
    <div className="absolute h-[28px] left-[70.89px] top-[77px] w-[91.219px]" data-name="Heading 4">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[18px] text-center top-[-1px] whitespace-nowrap">최민지</p>
    </div>
  );
}
...
function Container82() {
  return (
    <div className="absolute bg-white h-[170px] left-[235px] rounded-[14px] top-[904px] w-[233px]" data-name="Container">
      <Container83 />
      <Heading25 />
      <Paragraph26 />
      <Container86 />
...
function Heading26() {
  return (
    <div className="absolute h-[28px] left-[71.1px] top-[92px] w-[91.219px]" data-name="Heading 4">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[18px] text-center top-[-1px] whitespace-nowrap">한태산</p>
    </div>
  );
}
...
function Container87() {
  return (
    <div className="absolute bg-white h-[170px] left-[489px] rounded-[14px] top-[904px] w-[233px]" data-name="Container">
      <Heading26 />
      <Container88 />
    </div>
  );
...
function Group2() {
  return (
    <div className="absolute contents left-[235px] top-[715px]">
      <Container74 />
      <Container77 />
      <Container82 />
      <Container87 />
...
function Heading27() {
  return (
    <div className="absolute h-[28px] left-[1005px] top-[680px] w-[91.219px]" data-name="Heading 10">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[25px] text-center top-[-1px] whitespace-nowrap">4팀</p>
    </div>
  );
}
...
function Heading28() {
  return (
    <div className="absolute h-[28px] left-[70.89px] top-[77px] w-[91.219px]" data-name="Heading 4">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[18px] text-center top-[-1px] whitespace-nowrap">류대성</p>
    </div>
  );
}
...
function Container89() {
  return (
    <div className="absolute bg-white h-[170px] left-[808px] rounded-[14px] top-[715px] w-[233px]" data-name="Container">
      <Container90 />
      <Heading28 />
      <Paragraph27 />
      <Container91 />
...
function Heading29() {
  return (
    <div className="absolute h-[28px] left-[70.89px] top-[77px] w-[91.219px]" data-name="Heading 4">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[18px] text-center top-[-1px] whitespace-nowrap">김맹구</p>
    </div>
  );
}
...
function Container92() {
  return (
    <div className="absolute bg-white h-[170px] left-[1062px] rounded-[14px] top-[715px] w-[233px]" data-name="Container">
      <Container93 />
      <Heading29 />
      <Paragraph28 />
      <Container96 />
...
function Heading30() {
  return (
    <div className="absolute h-[28px] left-[70.89px] top-[77px] w-[91.219px]" data-name="Heading 4">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[18px] text-center top-[-1px] whitespace-nowrap">최지민</p>
    </div>
  );
}
...
function Container97() {
  return (
    <div className="absolute bg-white h-[170px] left-[808px] rounded-[14px] top-[904px] w-[233px]" data-name="Container">
      <Container98 />
      <Heading30 />
      <Paragraph29 />
      <Container101 />
...
function Heading31() {
  return (
    <div className="absolute h-[28px] left-[71.1px] top-[92px] w-[91.219px]" data-name="Heading 4">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[46px] not-italic text-[#101828] text-[18px] text-center top-[-1px] whitespace-nowrap">권지용</p>
    </div>
  );
}
...
function Container102() {
  return (
    <div className="absolute bg-white h-[170px] left-[1062px] rounded-[14px] top-[904px] w-[233px]" data-name="Container">
      <Heading31 />
      <Container103 />
    </div>
  );
...
function Group3() {
  return (
    <div className="absolute contents left-[808px] top-[715px]">
      <Container89 />
      <Container92 />
      <Container97 />
      <Container102 />
...
function App() {
  return (
    <div className="bg-[#f9fafb] h-[1509px] relative shrink-0 w-[1536px]" data-name="App">
      <PlaceholderForApp />
      <Container6 />
      <Heading11 />
      <div className="absolute bg-[#eff6ff] h-[418px] left-[216px] rounded-[10px] shadow-[2px_4px_4px_3px_rgba(0,0,0,0.25)] top-[229px] w-[522px]" />
      <p className="-translate-x-1/2 absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[28px] left-[479px] not-italic text-[#101828] text-[25px] text-center top-[240px] whitespace-nowrap">1팀</p>
      <Container44 />
      <Container47 />
      <Container52 />
      <Container57 />
      <Heading16 />
      <div className="absolute bg-[#eff6ff] h-[418px] left-[788px] rounded-[10px] shadow-[2px_4px_4px_3px_rgba(0,0,0,0.25)] top-[228px] w-[522px]" />
      <Heading17 />
      <Group1 />
      <div className="absolute bg-[#eff6ff] h-[418px] left-[215px] rounded-[10px] shadow-[2px_4px_4px_3px_rgba(0,0,0,0.25)] top-[668px] w-[522px]" />
      <Heading22 />
      <Group2 />
      <div className="absolute bg-[#eff6ff] h-[418px] left-[788px] rounded-[10px] shadow-[2px_4px_4px_3px_rgba(0,0,0,0.25)] top-[668px] w-[522px]" />
      <Heading27 />
      <Group3 />
    </div>
  );
...
export default function Component() {
  return (
    <div className="bg-gradient-to-b content-stretch flex flex-col from-[#151515] items-start relative size-full to-[#454545]" data-name="프로필-랜덤 팀 생성">
      <App />
    </div>
  );
}