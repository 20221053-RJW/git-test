...
function Button4() {
  return (
    <div className="bg-[#3676ff] h-[44px] relative rounded-[10px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.1)] shrink-0 w-[104px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Frame() {
  return (
    <div className="-translate-y-1/2 absolute bg-white h-[789px] left-[281px] rounded-[14px] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)] top-[calc(50%-152px)] w-[944px]" data-name="Frame">
      <Heading11 />
      <Container44 />
      <Container45 />
      <Container46 />
