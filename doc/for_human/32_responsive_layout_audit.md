...
모바일 **햄버거 메뉴·사이드 스택·그리드 단계**는 대체로 잘 되어 있습니다. **2026-05-22 저녁**에 shell·푸터·일부 페이지 이중 `max-w-*`를 정리했습니다. **교수 평가 모달 `px-16`**·전역 `overflow-x: hidden` 등은 아직 잔여입니다.
...
### 1. 교수 프로젝트 평가 모달 (팀 워크스페이스)

- **위치:** `TeamDetailPage.tsx` — 본문 `px-16`, 제목 `text-[25px]`
- **문제:** 320px 폭에서 좌우 여백만 크고 글 읽기 어려움
- **권장:** `px-4 sm:px-8 lg:px-16`, 제목 `text-xl sm:text-2xl`
