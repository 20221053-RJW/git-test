...
| 153 | 로그인 버튼 세로 패딩 | ✅ | `landing-login-submit` `py-3` `min-h-[2.75rem]` ([`260526-1`](../for_agent/plans/260526-1.md)) |
...
1. `vision.md` 변경 시 `27`·본 문서 §상세(1~#153)·`26`을 같은 세션에 갱신한다.
