...
> **갱신:** 2026-06-09 (vision #164~#169 회고록·마이페이지·피드백 워딩)
...
| 강의자료 Storage (#83) | ✅ | T-204 | MCP 원격 버킷·RLS (2026-05-25) |
| 교수 네비 팀참여 숨김 (#84) | ✅ | T-203 | 학생만 `MyTeamSideNavGroup` |
| 강의자료 업로드 (#60) | ❌ | — | 후속 |
| 팀카드 알림 (#67) | ❌ | — | 후속 |
| 대용량 업로드 UX (#71) | ❌ | — | 후속 |
| 산출물·TS UX (#72~#75) | ❌ | — | 후속 |
| 회고록 자동연동 변경 (#164) | ✅ | T-205 | 역할·아쉬운·발전=수기, 잘한점=TS+수기 |
| 마이페이지 내가 한 경험 (#165) | ✅ | T-206 | 회고록 custom 4섹션 종합 |
| 평가→피드백 워딩 (#166) | ✅ | T-207 | 주요 UI 라벨 |
| 학생·동료 저장 실패 UX (#167·#168) | ✅ | T-208 | verify·manner temp non-fatal |
| 산출물 등록 예시 (#169) | ✅ | T-209 | 회의록·텍스트 문서 안내 |
| 교수·타인 담당 수업 카드 (#170) | ✅ | T-210 | slate 스타일·다른 교수 담당 배지 |
| 타인 담당 수업 입장 alert (#171) | ✅ | T-211 | catalog·내 강의 카드 |
| 교수 프로필 사진 변경 (#172) | ✅ | T-212 | `/app/profile/professor` |
...
| 신규 추가요청 #60~#84 | 100% | 2026-05-23 T-185~204 · #83 MCP 원격 적용 (2026-05-25) |
